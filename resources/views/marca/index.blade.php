...
<div class="row">
  ...
  <div class="col-sm-8"><h1>Marca de Productos</h1></div>
</div>
 

<button class="glyphicon glyphicon-plus" data-toggle="modal" data-target="#create">Agregar Marca</button>
<br>
<br>
<br>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <form class="w3-container" action="/Marca/delete" method="POST" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
              {{ csrf_field() }}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><h1>Crear Marca de Producto</h1></h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" role="form" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
          ...
          <div class="form-group row add">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="cmarca" name="cmarca" onKeyUp="javascript:this.value = this.value.replace(/,/,'');document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" 
        ...
        <form class="form-horizontal" role="form" onKeypress="if(event.keyCode == 13) event.returnValue = false;">
          ...
          <div class="form-group row add">
            ...
            <div class="col-sm-10">
              ...
              <input type="text" class="form-control" id="tnombre" name="tnombre"  onKeyUp="javascript:this.value = this.value.replace(/,/,'');document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()"  placeholder="Ingresa Nombre" required>
  ...
  $("#add").click(function() {
    $.ajax({
      ...
      data: {
        ...
        'cmarca': $('input[name=cmarca]').val()
      },
      success: function(data) {
                if ((data.errors)){
             $('.error').removeClass('hidden');
                    $('.error').text(data.errors.cmarca);
